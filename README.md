...
I have written knowledge integrators for formal and prosaic texts, typed data, highly structured data (annotated abstract syntax graphs for source code), and ephemeral events for online knowledge graph tech demos and find that these repositories will form the foundation of the next generation of AI applications. Especially deeply structural data (like ASTs + symbol references) offer an extremely promising reduction in complexity by offering navigatable and selectable texture. This stabilizes reasoning with genAI models and fully supports sustained agentic code maintenance with a developer piloting it.
